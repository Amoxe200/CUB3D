...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/04/27 15:40:46 by aaqari            #+#    #+#             */
/*   Updated: 2021/04/30 16:30:11 by aaqari           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	fill_map(t_struct *g)
{
	...
	{
		g->map_conf.map[i] = my_malloc((g->tmp_width + 3) * sizeof(char), g);
		g->map_conf.map[i][g->tmp_width + 2] = '\0';
		i++;
	}
	...
	free(g->map_conf.world);
	free(g->map_conf.wlrd);
}
